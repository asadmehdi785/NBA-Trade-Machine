...
$("#testtrade").click(function() {
    ...
    prompt("Attention! Player Joe Harris has an expiring contract. Please input the salary desired for this player (to be traded via sign-and-trade) (in millions to two decimals): ");
